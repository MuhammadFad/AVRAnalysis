...
# (SSIM, edge, color, aggregator, reporters) depend on receiving properly
# formatted images from this module. Any issues here cascade through the
# entire pipeline.
#
# OUTPUT FORMAT:
...
def load_images(baseline_path: str, optimized_path: str):
    ...
    # ========================================================================
    # OpenCV uses BGR by convention (legacy reason from early camera libraries).
    # Most computer vision literature, PIL, matplotlib, and numpy conventions
    # use RGB. We convert here once so all downstream modules are consistent.
    ...
    # in downstream SSIM and edge pass computations.
    ...
    # Grayscale or RGBA images will cause issues in downstream computation.
    ...
    # ========================================================================
    # File format uses uint8 [0,255] for compact storage. All pipeline passes
    # expect float64 [0,1] for numerical stability and scale-invariance.
